...
public class Main {
	...
	public static void main(String[] args) {
		...
		Set<Character> out = new HashSet<Character>(Arrays.asList('0', '1', '2'));
...
//		
//		m.getStates().get(1).addTranslation(new Translation('a', '1', m.getStates().get(0)));
//		m.getStates().get(1).addTranslation(new Translation('c', '0', m.getStates().get(0)));
		
		m.getStates().get(0).addTranslation(new Translation('a', '1', m.getStates().get(0)));
		m.getStates().get(0).addTranslation(new Translation('b', '0', m.getStates().get(0)));
		
		m.getStates().get(1).addTranslation(new Translation('a', '2', m.getStates().get(0)));
